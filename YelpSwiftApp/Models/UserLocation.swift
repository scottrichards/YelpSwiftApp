...
class UserLocation: NSObject, CLLocationManagerDelegate {
    ...
    internal class UserLocationManager: NSObject, CLLocationManagerDelegate {
        ...
        var internalFoundLocation:  Bool = false    // true if was able to detect current location
        ...
        func locationManager(manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
            ...
            if location.horizontalAccuracy > 0 {
                ...
                internalFoundLocation = true    // we found a location
    ...
    var foundLocation : Bool {
        get {
            return manager.internalFoundLocation
        }
    }
